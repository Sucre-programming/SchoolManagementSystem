<div class="w-full block mt-8">
    <div class="flex flex-wrap sm:flex-no-wrap justify-between">
        <div class="w-full bg-gray-200 text-center  border-gray-300 px-8 py-6 rounded dashboardTile">
        ...
        <div class="w-full bg-gray-200 text-center  border-gray-300 px-8 py-6 mx-0 sm:mx-6 my-4 sm:my-0 rounded dashboardTile">
            <h3 class="text-gray-700 uppercase font-bold">
...
<div class="w-full block mt-8">
    <div class="flex flex-wrap sm:flex-no-wrap justify-between">
        <div class="w-full sm:w-1/2 mr-2 mb-6">
            <h3 class="text-gray-700 uppercase font-bold mb-2 pageTitle">Class List</h3>
            <div class="flex flex-wrap items-center">
                @foreach ($teacher->classes as $class)
                    <div class="w-full sm:w-1/2 text-center border border-gray-400 rounded bg-gray-200">
        ...
        <div class="w-full sm:w-1/2 ml-2 mb-6">
            <h3 class="text-gray-700 uppercase font-bold mb-2 pageTitle">Subject List</h3>
