<div class="sidebar overflow-y-auto customSideBarWrapper">
    ...
    <div class="customSideBar">
        ...
        @role('Admin')
        <a href="{{ route('teacher.index') }}" class="flex items-center sidebarText">
            ...
            <span class="ml-2 font-semibold">Teachers</span>
        </a>
        <a href="{{ route('subject.index') }}" class="flex items-center sidebarText">
            ...
            <span class="ml-2 font-semibold">Subjects</span>
        </a>
        <a href="{{ route('classes.index') }}" class="flex items-center sidebarText">
            ...
            <span class="ml-2 font-semibold">Classes</span>
        </a>

        <a href="{{ route('parents.index') }}" class="flex items-center sidebarText">
            ...
            <span class="ml-2 font-semibold">Parents</span>
        </a>
        <a href="{{ route('student.index') }}" class="flex items-center sidebarText">
        ...
        <a href="{{ route('attendance.index') }}" class="flex items-center sidebarText">
            ...
            <span class="ml-2 font-semibold">Attendance Report</span>
        </a>
        <a href="{{ route('assignrole.index') }}" class="flex items-center sidebarText">
            ...
            <span class="ml-2 font-semibold">Assign Role</span>
        </a>
        <a href="{{ route('roles-permissions') }}" class="flex items-center sidebarText">
            ...
            <span class="ml-2 font-semibold">Roles &amp; Permissions</span>
        </a>
        @endrole
    </div>
